...
const whyChooseVariations = [
  ...
  (city: string) => `Don't just take our word for it — our 5-star rating from real ${city}-area customers speaks for itself. We've earned our reputation one project at a time, and we're proud of every single review.`,
